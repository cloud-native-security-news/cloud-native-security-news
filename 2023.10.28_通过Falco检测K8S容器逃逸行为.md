...
![1698460544954](image/2023.10.28_/1698460544954.png)
...
![1698468600557](image/2023.10.28_/1698468600557.png)

攻击者获取到容器权限后进行后渗透时能及时发现


回到 `CAP_SYS_ADMIN` 权限，攻击者可以选择利用镜像内置命令进行容器逃逸，如利用 mount 宿主机硬盘，这需要自定义规则检测
...
[Try Falco on Kubernetes | Falco](https://falco.org/docs/getting-started/falco-kubernetes-quickstart/)

[How to detect the containers’ escape capabilities with Falco – Sysdig](https://sysdig.com/blog/container-escape-capabilities-falco-detection/)

[Falco Playground (falcosecurity.github.io)](https://falcosecurity.github.io/falco-playground/)

[CloudDefenseAI/falco_extended_rules: Curating Falco rules with MITRE ATT&amp;CK Matrix (github.com)](https://github.com/CloudDefenseAI/falco_extended_rules)
